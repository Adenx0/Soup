...
public class BlueMedicineFlowerBlock extends SoupModElements.ModElement {
	@ObjectHolder("soup:blue_medicine_flower")
	public static final Block block = null;

	public BlueMedicineFlowerBlock(SoupModElements instance) {
		super(instance, 16);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blue_medicine_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soup:blue_medicine_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blue_medicine_flower");
		}
