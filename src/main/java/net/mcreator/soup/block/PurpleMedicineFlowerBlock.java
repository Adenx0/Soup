...
package net.mcreator.soup.block;
...
public class PurpleMedicineFlowerBlock extends SoupModElements.ModElement {
	@ObjectHolder("soup:purple_medicine_flower")
	public static final Block block = null;

	public PurpleMedicineFlowerBlock(SoupModElements instance) {
		super(instance, 14);
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(SoupItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("purple_medicine_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soup:purple_medicine_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("purple_medicine_flower");
		}
