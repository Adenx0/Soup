...
public class RedMedicineFlowerBlock extends SoupModElements.ModElement {
	@ObjectHolder("soup:red_medicine_flower")
	public static final Block block = null;

	public RedMedicineFlowerBlock(SoupModElements instance) {
		super(instance, 15);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_medicine_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soup:red_medicine_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("red_medicine_flower");
		}
