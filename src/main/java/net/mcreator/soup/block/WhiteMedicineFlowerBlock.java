...
public class WhiteMedicineFlowerBlock extends SoupModElements.ModElement {
	@ObjectHolder("soup:white_medicine_flower")
	public static final Block block = null;

	public WhiteMedicineFlowerBlock(SoupModElements instance) {
		super(instance, 17);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("white_medicine_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soup:white_medicine_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("white_medicine_flower");
		}
